...
class DesktopSettingPage extends StatefulWidget {
  final SettingsTabKey initialTabkey;
    ...
    // Account tab hidden per user request. To re-enable, remove the '&& false' or uncomment.
    if (!bind.isDisableAccount() && false) SettingsTabKey.account,
    if (isWindows &&
...
class _NetworkState extends State<_Network> with AutomaticKeepAliveClientMixin {
  ...
  Widget network(BuildContext context) {
    final hideServer = bind.mainGetLocalOption(key: 'hide-server-menu') == 'Y';
    final hideProxy =
...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About HelpDesk - TruongIT.NET'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://helpdesk.truongit.net/privacy.html');
                  },
                  child: Text(
              ...
              InkWell(
                ...
                SelectionArea(
                    child: Text(translate('About_Helpdesk_Description')))
