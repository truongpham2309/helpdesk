...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới HelpDesk..."),
        ...
        ("Website", "Trang web"),
        ("About", "Giới thiệu"),
        ("Slogan_tip", "Giải pháp HelpDesk toàn diện – Hỗ trợ tức thì, Bảo mật Tự chủ."),
        ("About_Helpdesk_Description", "HelpDesk - TruongIT.NET là hệ thống quản lý hỗ trợ kỹ thuật thế hệ mới. Chúng tôi tận dụng triệt để sức mạnh của nền tảng mã nguồn mở RustDesk, được xây dựng bằng ngôn ngữ lập trình Rust, để đảm bảo mọi kết nối từ xa đều đạt tốc độ cao, ổn định và an toàn tuyệt đối về bảo mật."),
        ...
        ("install_tip", "Do UAC, HelpDesk sẽ không thể hoạt động đúng cách là bên từ xa trong vài trường hợp. Để tránh UAC, hãy nhấn cái nút dưới đây để cài HelpDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cài đặt"),
        ("config_acc", "Để có thể điều khiển máy tính từ xa, bạn cần phải cung cấp quyền \"Trợ năng\" cho HelpDesk"),
        ("config_screen", "Để có thể truy cập máy tính từ xa, bạn cần phải cung cấp quyền \"Ghi Màn Hình\" cho HelpDesk."),
        ("Installing ...", "Đang cài ..."),
        ("Install", "Install"),
        ...
        ("The verification code is incorrect or has expired", "Mã xác minh không chính xác hoặc đã hết hạn"),
        ...
        ("The key has expired. Please update to continue using the application.", "Key đã hết hạn. Vui lòng cập nhật để tiếp tục sử dụng ứng dụng."),
        ...
        ("An unknown error has occurred. Please try again", "Đã xảy ra lỗi không xác định. Vui lòng thử lại"),
        ("Empty", "Trống"),
        ...
        ("android_input_permission_tip1", "Để thiết bị từ xa điều khiển thiết bị Android của bạn bằng chuột hoặc chạm, bạn cần cho phép HelpDesk sử dụng dịch vụ \"Trợ năng\"."),
        ("android_input_permission_tip2", "Vui lòng chuyển đến trang cài đặt hệ thống tiếp theo, tìm và nhập [Dịch vụ đã cài đặt], bật dịch vụ [HelpDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep RustDesk background service", "Giữ dịch vụ nền HelpDesk"),
        ("Ignore Battery Optimizations", "Bỏ qua các tối ưu pin"),
        ("android_open_battery_optimizations_tip", "Nếu bạn muốn tắt tính năng này, vui lòng chuyển đến trang cài đặt ứng dụng HelpDesk tiếp theo, tìm và nhập [Pin], Bỏ chọn [Không hạn chế]"),
        ...
        ("config_input", "Để điều khiển được máy tính từ xa với bàn phím, bạn cần cho phép HelpDesk quyền \"Theo dõi đầu vào\" (Input Monitoring)"),
        ("config_microphone", "Để nói chuyện từ xa, bạn phải cho phép HelpDesk quyền \"Ghi âm thanh\" (Record Audio)"),
        ...
        ("still_click_uac_tip", "Vẫn cần người dùng từ xa nhấn OK trên cửa sổ UAC của HelpDesk đang chạy."),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu HelpDesk"),
        ...
        ("clipboard_wait_response_timeout_tip", "Hết thời gian chờ phản hồi từ clipboard."),
        ("Incoming connection", "Kết nối đến"),
        ("Outgoing connection", "Kết nối đi"),
        ("Exit", "Thoát"),
        ("Open", "Mở"),
        ("logout_tip", "Bạn có chắc muốn đăng xuất không?"),
        ("Service", "Dịch vụ"),
        ("Start", "Bắt đầu"),
        ("Stop", "Dừng lại"),
        ("exceed_max_devices", ""),
        ...
        ("License days left", "Giấy phép: còn {days} ngày"),
        ("License expired short", "Giấy phép: đã hết hạn"),
        ("License Invalid", "Giấy Phép Không Hợp Lệ"),
        ("Your license has been disabled or is no longer valid.", "Giấy phép của bạn đã bị vô hiệu hóa hoặc không còn hợp lệ."),
        ("License is invalid", "License không hợp lệ"),
        ("Your license is invalid. Please enter a new license key.", "License của bạn không hợp lệ. Vui lòng nhập license key mới."),
        ("License has expired", "License đã hết hạn"),
        ("Your license has expired. Please enter a new license key.", "License của bạn đã hết hạn. Vui lòng nhập license key mới."),
        ("License has been disabled", "License đã bị vô hiệu hóa"),
        ("Your license has been disabled. Please enter a new license key.", "License của bạn đã bị vô hiệu hóa. Vui lòng nhập license key mới."),
        ("License hardware mismatch", "License không khớp phần cứng"),
        ("License does not match this hardware. Please enter a new license key.", "License không khớp với phần cứng này. Vui lòng nhập license key mới."),
        ("License error occurred", "License bị lỗi"),
        ("License encountered an unknown error. Please enter a new license key.", "License gặp lỗi không xác định. Vui lòng nhập license key mới."),
    ].iter().cloned().collect();
}
