...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the HelpDesk network..."),
        ...
        ("install_tip", "Due to UAC, HelpDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install HelpDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant HelpDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant HelpDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow HelpDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [HelpDesk Input] service."),
        ...
        ("doc_mac_permission", "https://helpdesk.truongit.net/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next HelpDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("wayland_experiment_tip", "Wayland support is in experimental stage, please use X11 if you require unattended access."),
            ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow HelpDesk to use the \"Accessibility\" service."),
            ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [HelpDesk Input] service."),
        ("config_microphone", "In order to speak remotely, you need to grant HelpDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running HelpDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verify HelpDesk password"),
        ...
        ("Accept and Elevate", "Accept and elevate"),
            ("floating_window_tip", "It helps to keep HelpDesk background service"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use HelpDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade HelpDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://helpdesk.truongit.net/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent HelpDesk from running properly as controlled side."),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, HelpDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, Helpdesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Helpdesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: HelpDesk server OSS doesn't include this feature."),
        ("powered_by_me", "Powered by TruongIT.NET"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if HelpDesk window is open"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the HelpDesk client to version {} or newer on the remote side!"),
